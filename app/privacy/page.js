        ...
        <>
            <div className="max-w-7xl mx-auto p-8 space-y-8 bg-gray-100 text-gray-800">
                ...
                <section>
                    ...
                    <p className="text-lg">
                        We at <strong>Print Hub Solutions
</strong>, located at the World Wide Web as{" "}
                        <a href="http://print-hubsolutions.com" className="text-blue-500 hover:underline">
                            www.print-hubsolutions.com
                ...
                <footer className="text-center text-gray-600">
                    <p className="text-sm">© 2025 Print Hub Solutions
